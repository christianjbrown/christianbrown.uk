...
export default {
    ...
    cookies: {
        question: 'Acceptez-vous que ce site utilise des cookies pour {traffic} et {errors} ?',
        measureTraffic: 'mesurer le trafic',
        catchErrors: 'détecter les erreurs',
        accept: '🍪 Oui',
        decline: '🚫 Non',
    },
    ...
    cv: {
        ...
        smartHomeLink: '🏠 Maison connectée',
