...
window.addEventListener('load',
    () => {
        ...
        const smartHomePage = new SmartHomePage(STATUS_LINE_SELECTOR, HOME_TEMP_TABLE_SELECTOR, HOME_TEMP_TABLE_UPDATE_TIME_SELECTOR, WEATHER_TABLE_SELECTOR, WEATHER_TABLE_UPDATE_TIME_SELECTOR);
